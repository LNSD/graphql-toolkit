...
where
    ...
    F: Formatter,
{
    pub(super) fn serialize_executable_document(
        &mut self,
        value: &ExecutableDocument,
    ) -> anyhow::Result<()> {
    ...
    pub(super) fn serialize_operation_definition(
        &mut self,
    ...
    pub(super) fn serialize_selection_set(&mut self, value: &SelectionSet) -> anyhow::Result<()> {
    ...
    pub(super) fn serialize_selection(&mut self, value: &Selection) -> anyhow::Result<()> {
        match value {
    ...
    pub(super) fn serialize_selection_field(&mut self, value: &Field) -> anyhow::Result<()> {
    ...
    pub(super) fn serialize_fragment_spread(
        &mut self,
    ...
    pub(super) fn serialize_inline_fragment(
        &mut self,
    ...
    pub(super) fn serialize_arguments(
        &mut self,
    ...
    pub(super) fn serialize_directive(&mut self, value: &Directive) -> anyhow::Result<()> {
    ...
    pub(super) fn serialize_variable_definition(
        &mut self,
    ...
    pub(super) fn serialize_type(&mut self, value: &Type) -> anyhow::Result<()> {
        match &value.base {
            BaseType::Named(name) => {
                name.serialize(self)?;
            }
    ...
    pub(super) fn serialize_type_condition(&mut self, value: &TypeCondition) -> anyhow::Result<()> {
        self.formatter.write_keyword(&mut self.writer, "on")?;
        self.formatter.write_separator(&mut self.writer)?;
        value.on.serialize(self)
    }

    pub(super) fn serialize_name(&mut self, value: &Name) -> anyhow::Result<()> {
        self.formatter
    ...
    pub(super) fn serialize_value(&mut self, value: &Value) -> anyhow::Result<()> {
        match value {
            Value::Null => {
    ...
    pub(super) fn serialize_value_array(&mut self, value: &[Value]) -> anyhow::Result<()> {
        self.formatter.begin_array(&mut self.writer)?;
    ...
    pub(super) fn serialize_value_object(
        &mut self,
        value: &IndexMap<Name, Value>,
    ) -> anyhow::Result<()> {
    ...
    pub(super) fn serialize_const_value(&mut self, value: &ConstValue) -> anyhow::Result<()> {
        match value {
            ConstValue::Null => {
                self.formatter.write_null(&mut self.writer)?;
            }
    ...
    pub(super) fn serialize_const_value_array(
        &mut self,
        value: &[ConstValue],
    ) -> anyhow::Result<()> {
        self.formatter.begin_array(&mut self.writer)?;
    ...
    pub(super) fn serialize_const_value_object(
        &mut self,
    ...
    pub(super) fn serialize_number(&mut self, value: &Number) -> anyhow::Result<()> {
